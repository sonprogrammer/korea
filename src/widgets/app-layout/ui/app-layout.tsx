...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
   <div className="h-screen w-full flex justify-center bg-[#0a0a0f]">
      <Layout
        className="h-full! max-w-120! flex! flex-col! relative!"
        style={{
          background: "#111118",
      ...
      >
        ...
        <Content
          className="mx-auto! w-full! flex-1! px-4! py-4! overflow-y-auto! scrollbar-none!"
